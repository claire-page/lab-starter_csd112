...
//wanted to be able to import and name these across all test files, unimportant but i will prob come back and do that.
    ...
    void testOptimusPicksWinOverBlocking() {
        ...
        Board winorblock4 = new Board("XOX" +
                                         "XO-" +
                                         "---");
        assertEquals(botLeft, Ooppy.getNextMove(winorblock4), "Optimus(X) should pick bottom Left, as it's the winning move, but it blocked instead.");
    }
}
