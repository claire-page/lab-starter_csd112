...
### Answer
Encapsulation is a big part of it- all the nitty gritty implementations are hidden away from the user (and the methods themselves even), so we don't have to change the game logic to
